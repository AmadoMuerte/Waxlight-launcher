...
- Несколько аккаунтов Vintage Story с поддержкой TOTP/2FA.
- Несколько версий игры одновременно.
- Изолированные сборки с отдельными модами и настройками.
- Встроенный браузер Vintage Story ModDB с поиском, фильтрами и управлением модами.
