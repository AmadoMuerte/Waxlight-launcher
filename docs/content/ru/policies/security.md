...
Windows-релизы в настоящее время не имеют цифровой подписи. Рекомендации по проверке релизов определяет [политика подписи кода](./code-signing.md). Метка «Verified» у git-тега на GitHub не равна Authenticode-подписи исполняемого файла.
