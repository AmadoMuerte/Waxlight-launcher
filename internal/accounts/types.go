...
var (
	...
	ErrStoreUnlockFailed   = errors.New("credential store unlock failed")
	ErrStoreDesktopSession = errors.New("credential store desktop session unavailable")
	ErrStoreUnknown        = errors.New("unknown credential store failure")
